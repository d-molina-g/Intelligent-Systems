...
public:
	...
	void printGRAPH ();
	void printRESULTS (char *argv[],string time_ejecution, string time_optimize,string SNUMBEROFCITIES,string SNUMBEROFANTS,string SINITIALCITY,string SALPHA,string SBETA,string SQ, string SRO);
